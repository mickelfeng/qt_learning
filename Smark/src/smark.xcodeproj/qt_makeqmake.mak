...
QMAKE    = /usr/bin/qmake
smark.xcodeproj/project.pbxproj: smark2.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o smark.xcodeproj/project.pbxproj smark2.pro
